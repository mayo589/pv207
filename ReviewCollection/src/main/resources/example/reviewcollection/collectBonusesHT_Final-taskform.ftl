<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("reviews");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isNumeric(myInputs[j])) {
							alert("Please enter valid reviews");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: CalculateBonus.collectBonusesHT_Final
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[analyst]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">in_employee</label>
                            		<div class="div_checkbox">
                              		${in_employee}
                            		</div>
                            		<label for="name">in_bonus</label>
                            		<div class="div_checkbox">
                              		${in_bonus}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="reviews" type="text" class="textbox" id="reviews" value="${reviews}" />
                            		</div>
