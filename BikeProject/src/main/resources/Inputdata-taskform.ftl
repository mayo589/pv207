<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("bikeAvailability");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid bikeAvailability");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: newBikeOrder.Inputdata
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">bikeAvailability</label>
                            		<div class="div_texbox">
                              		<input name="bikeAvailability" type="text" class="textbox" id="bikeAvailability" value="${bikeAvailability}" />
                            		</div>
