<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("results");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: CalculateBonus.ReviewTask_Final
	</div>
	<div id="content">
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<input name="results" type="checkbox" class="checkbox" id="results" value="${results}" />
                            		</div>
